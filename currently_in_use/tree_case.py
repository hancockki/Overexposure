...
# # OLD GREEDY DP (aka Knapsack)
# # did not compute payoffs accuratley
...
# # THIS APPROACH DOES NOT WORK!!!! Direct translation of knapsack
# def traditional_knapsack(G, i, k): #doesn't consider subtrees
#     #This is different since we are considering each node's weight in the graph to be the number of accepting nodes in a given cluster
#     #i = number_of_nodes(G)
#     #k = number of seeds
